        ...
        for (let i = 0; i < items.length; i++) {
            ...
            switch (child.tagName) {
                ...
                case "up":
                    ...
                    break;
                case "heightangle":
                    this.cameraData.heightAngle = parseFloat(child.getAttribute("v") || child.getAttribute("value"));
                    break;
                case "aspectratio":
                    this.cameraData.aspectRatio = parseFloat(child.getAttribute("v") || child.getAttribute("value"));
                    break;
                case "aperture":
                    this.cameraData.aperture = parseFloat(child.getAttribute("v") || child.getAttribute("value"));
                    break;
                case "focallength":
                    this.cameraData.focalLength = parseFloat(child.getAttribute("v") || child.getAttribute("value"));
                    break;
                default:
        ...
        for (let i = 0; i < items.length; i++) {
            ...
            switch (child.tagName) {
                ...
                case "transparent":
                    ...
                    break;
                case "shininess":
                    mat.shininess = parseFloat(child.getAttribute("v") || child.getAttribute("value"));
                    break;
                case "ior":
                    mat.ior = parseFloat(child.getAttribute("v") || child.getAttribute("value"));
                    break;
                case "texture":
                ...
                case "bumpmap":
                    ...
                    break;
                case "blend":
                    mat.blend = parseFloat(child.getAttribute("v") || child.getAttribute("value"));
                    break;
                default:
